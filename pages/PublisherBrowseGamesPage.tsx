...
interface PublisherBrowseGamesPageProps {
  user: User;
  onLogout: () => void;
}

const PublisherBrowseGamesPage: React.FC<PublisherBrowseGamesPageProps> = ({
  user,
  onLogout,
}) => {
...
export default PublisherBrowseGamesPage;
