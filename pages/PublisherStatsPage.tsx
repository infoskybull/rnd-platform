...
interface PublisherStatsPageProps {
  user: User;
  onLogout: () => void;
}

const PublisherStatsPage: React.FC<PublisherStatsPageProps> = ({
  user,
  onLogout,
}) => {
  ...
  return (
    <div className="h-screen bg-gray-900 text-gray-200 flex overflow-hidden">
      {/* Sidebar */}
      <Sidebar userRole="publisher" activeTab="stats" onTabChange={() => {}} />
...
export default PublisherStatsPage;
